...
describe('ToolError', () => {
  it('carries a stable name and code', () => {
    ...
    expect(Object.values(ToolErrorCode)).toEqual([
      ...
      'ENGINE_UNDECLARED', 'ENGINE_KIND_MISMATCH', 'ENGINE_UNKNOWN_FN', 'ENGINE_ARGS',
      'ENGINE_VOID_TARGET', 'ENGINE_TARGET_REQUIRED', 'ENGINE_UNSUPPORTED_VARIANT',
      'ENGINE_UNSUPPORTED_PREFIX', 'ENGINE_FN_FAILED', 'REGISTER_MISSING_RETURNS', 'REGISTER_DUPLICATE',
    ])
  })
})
