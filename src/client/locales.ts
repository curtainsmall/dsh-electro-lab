...
const zh = {
  ...
  declarationLabel: '声明（JSON）',
  declarationNotObject: '声明必须是 JSON 对象。',
  declarationInvalid: '声明不是合法 JSON。',
...
const en: Record<keyof typeof zh, string> = {
  ...
  declarationLabel: 'Declaration (JSON)',
  declarationNotObject: 'The declaration must be a JSON object.',
  declarationInvalid: 'The declaration is not valid JSON.',
