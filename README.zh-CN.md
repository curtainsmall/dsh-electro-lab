...
工具集覆盖电路、信号与电子学计算，支持复数、精确单位换算，且求解结果总带有校验。工具由**智能体调用，而非你手动输入**——你描述问题，它挑选工具、喂入条件并汇报结果。工具列表见[docs/tools.zh-CN.md](docs/tools.zh-CN.md)。
...
- [docs/tools.zh-CN.md](docs/tools.zh-CN.md)
