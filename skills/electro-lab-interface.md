...
If the problem lacks the conditions needed, or no available tool can produce the required quantity: state exactly what is missing and which tool would be needed, and stop. Never invent values or continue with fabricated conditions.
